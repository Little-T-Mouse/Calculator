...
def equalpress():
    try:
        ...
        if "/0" in shown:
            equation.set("Cannot Divide By Zero / Number With Prefix '0'")
        else:
...
exp = Button(window, text='^x', fg='black', bg='gray',
                command=lambda: press("**"), height=3, width=7)
exp.grid(row=3, column=4)
rb = Button(window, text='(', fg='black', bg='gray',
                command=lambda: press("("), height=3, width=7)
rb.grid(row=4, column=4)
lb = Button(window, text=')', fg='black', bg='gray',
                command=lambda: press(")"), height=3, width=7)
lb.grid(row=5, column=4)
mod = Button(window, text='%', fg='black', bg='gray',
                command=lambda: press("%"), height=3, width=7)
mod.grid(row=6, column=4)
divint = Button(window, text='//', fg='black', bg='gray',
                command=lambda: press("//"), height=3, width=7)
divint.grid(row=7, column=4)
window.mainloop()
